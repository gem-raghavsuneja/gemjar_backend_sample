...
public class Postgems extends QuanticAPIBase {
    @Test(dataProvider = "QuanticDataProvider", dataProviderClass = QuanticDataProvider.class)
    public void Postsuite_Function_srunidnotexists(JsonObject inputData){
        GemTestReporter.addTestStep("Test Case", "Test to check the Post function ", STATUS.INFO);
        String url= ProjectApiUrl.getUrl("pos");
        GemTestReporter.addTestStep("Url for Post Request", url, STATUS.INFO);

        JsonObject payload = ProjectSampleJson.getSampleData("post1_sampleJson").getAsJsonObject();
...
String me=body.get("message").toString();
    ...
    @Test(dataProvider = "QuanticDataProvider", dataProviderClass = QuanticDataProvider.class)
    public void Postsuite_Function_srunidnotpresentinpayload(JsonObject inputData){
        GemTestReporter.addTestStep("Test Case", "Test to check the Post function ", STATUS.INFO);
        String url=ProjectApiUrl.getUrl("pos");
        GemTestReporter.addTestStep("Url for Post Request", url, STATUS.INFO);

        JsonObject payload = ProjectSampleJson.getSampleData("post2_sampleJson").getAsJsonObject();
        GemTestReporter.addTestStep("Payload ", String.valueOf(payload), STATUS.INFO);
    ...
    @Test(dataProvider = "QuanticDataProvider", dataProviderClass = QuanticDataProvider.class)
    public void Postsuite_Function_uniquetcrunid(JsonObject inputData){
        GemTestReporter.addTestStep("Test Case", "Test to check the Post function ", STATUS.INFO);
        String url=ProjectApiUrl.getUrl("pos");
        GemTestReporter.addTestStep("Url for Post Request", url, STATUS.INFO);

        JsonObject payload = ProjectSampleJson.getSampleData("post3_sampleJson").getAsJsonObject();
        GemTestReporter.addTestStep("Payload ", String.valueOf(payload), STATUS.INFO);
    ...
    @Test(dataProvider = "QuanticDataProvider", dataProviderClass = QuanticDataProvider.class)
    public void Postsuite_Function_tcrunidnotpresentinpayload(JsonObject inputData){
        GemTestReporter.addTestStep("Test Case", "Test to check the Post function ", STATUS.INFO);
        String url=ProjectApiUrl.getUrl("pos");
        GemTestReporter.addTestStep("Url for Post Request", url, STATUS.INFO);

        JsonObject payload = ProjectSampleJson.getSampleData("post4_sampleJson").getAsJsonObject();
        GemTestReporter.addTestStep("Payload ", String.valueOf(payload), STATUS.INFO);
