...
public class parsejson extends QuanticAPIBase {
...
JsonObject payload2=ProjectSampleJson.getSampleData("new2_sampleJson").getAsJsonObject();
    ...
    public static int getkey(JsonObject obj,String Key )
    {
        ...
        if (obj.has(Key))
        {
            GemTestReporter.addTestStep("Value of keyword TOTAL", String.valueOf(obj.get(Key)), STATUS.INFO);
